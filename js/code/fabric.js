$(document).ready(function () {
    var jqxhr = $.get("http://localhost:8080/code/fabric", function (data, status) {
        const { items } = data
...
$(document).on('click', '#code-fabric-item-delete', function () {
    ...
    var jqxhr = $.post("http://localhost:8080/code/fabric/delete", {
        id
...
$('#code-fabric-btn-add').click(() => {
    ...
    var jqxhr = $.post("http://localhost:8080/code/fabric/add", {
        item
    }, function (data, status) {
        addFabric(item)
    })
...
$('#code-fabric-btn-edit').click(() => {
    ...
    var jqxhr = $.post("http://localhost:8080/code/fabric/edit", {
        item
    }, function (data, status) {

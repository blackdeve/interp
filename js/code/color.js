$(document).ready(function () {
    var jqxhr = $.get("http://18.217.120.229:8080/code/color", function (data, status) {
        const { items } = data
        console.log(items)
...
$(document).on('click', '#code-color-item-delete', function () {
    ...
    var jqxhr = $.post("http://18.217.120.229:8080/code/color/delete", {
        id
...
$('#code-color-btn-add').click(() => {
    ...
    var jqxhr = $.post("http://18.217.120.229:8080/code/color/add", {
        item
    }, function (data, status) {
        addColor(item)
    })
...
$('#code-color-btn-edit').click(() => {
    ...
    var jqxhr = $.post("http://18.217.120.229:8080/code/color/edit", {
        item
    }, function (data, status) {

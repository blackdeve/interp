$(document).ready(function () {
    var jqxhr = $.get("http://18.217.120.229/code/size", function (data, status) {
        const { items } = data
        console.log(items)
...
$(document).on('click', '#code-size-item-delete', function () {
    ...
    var jqxhr = $.post("http://18.217.120.229/code/size/delete", {
        id
...
$('#code-size-btn-add').click(() => {
    ...
    var jqxhr = $.post("http://18.217.120.229/code/size/add", {
        item
    }, function (data, status) {
        addSize(item)
    })
...
$('#code-size-btn-edit').click(() => {
    ...
    var jqxhr = $.post("http://18.217.120.229/code/size/edit", {
        item
    }, function (data, status) {

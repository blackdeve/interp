$(document).ready(function () {
    var jqxhr = $.get("http://18.217.120.229/code/yarn", function (data, status) {
        const { items } = data
...
$(document).on('click', '#code-yarn-item-delete', function () {
    ...
    var jqxhr = $.post("http://18.217.120.229/code/yarn/delete", {
        id
...
$('#code-yarn-btn-add').click(() => {
    ...
    var jqxhr = $.post("http://18.217.120.229/code/yarn/add", {
        item
    }, function (data, status) {
        addYarn(item)
    })
...
$('#code-yarn-btn-edit').click(() => {
    ...
    var jqxhr = $.post("http://18.217.120.229/code/yarn/edit", {
        item
    }, function (data, status) {

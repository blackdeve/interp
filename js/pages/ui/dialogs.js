...
function showConfirmMessage() {
    swal({
        ...
        swal("Eliminado!", "Los datos han sido eliminados.", "success");
    });
}

function showConfirmSaveMessage() {
    swal({
        title: "¿Estás seguro?",
        ...
        swal("Guardado!", "Los datos han sido guardado.", "success");
    });
}
...
function showCancelMessage() {
    swal({
        ...
        if (isConfirm) {
            ...
            swal("Cancelado", "La información está segura :)", "error");
        }
    });
}
